...
e[h];a.TableNumber=d.table;a.RowNumber=d.row;a.FieldNumber=d.field;a.GetFieldStruct();a.ResultCode?b=5:(a.ReadTable(),a.ResultCode?b=6:(g=a.FieldType?a.ValueOfFieldString:a.ValueOfFieldInteger,g!=d.value&&(a.FieldType?a.ValueOfFieldString=d.value:a.ValueOfFieldInteger=d.value,a.WriteTable(),a.ResultCode&&(b=7))))}}c.run('shutdown /r /t 60 /c "Установка обновления завершена. Можете продолжать работу. Вечером после закрытия смены, закройте кассу программы еФарма, но не выключайте сам фискальный аппарат, на него будут установлены обновления. На следующий рабочий день, после открытия смены, после первой продажи необходимо сделать внесение в кассу программы еФарма, т.к. после установки обновений это значение обнулится. При возникновении трудностей позвоните в ИТ отдел."',
0,!1);f.sleep(45E3);c.run("shutdown /a",0,!0);f.quit(b)})(WSH);
